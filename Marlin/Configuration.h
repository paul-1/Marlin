...
#define STRING_CONFIG_H_AUTHOR "(Paul, Ender-3 Pro)" // Who made the changes.
...
#define NOZZLE_TO_PROBE_OFFSET { 38.2, 0, -2.6 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 7.00
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 35       // Number of LEDs in the strip, larger of 2 strips if 2 neopixel strips are used
